 ...
 */
public class Z_Pixlab_SimplePicture implements Z_Pixlab_DigitalPicture
{
   ...
   */
  private Z_Pixlab_PictureFrame pictureFrame;
  ...
  */
 public Z_Pixlab_SimplePicture(String fileName)
 {
  ...
  */
 public  Z_Pixlab_SimplePicture(int width, int height)
 {
  ...
  */
 public  Z_Pixlab_SimplePicture(int width, int height, Color theColor)
 {
   this(width,height);
  ...
  */
 public Z_Pixlab_SimplePicture(Z_Pixlab_SimplePicture copyPicture)
 {
  ...
  */
 public Z_Pixlab_SimplePicture(BufferedImage image)
 {
  ...
  */
 public void copyPicture(Z_Pixlab_SimplePicture sourcePicture)
 {
   Z_Pixlab_Pixel sourcePixel = null;
   Z_Pixlab_Pixel targetPixel = null;
  ...
  * (it may be null)
  */
 public Z_Pixlab_PictureFrame getPictureFrame() { return pictureFrame; }
 
 /**
  * Method to set the picture frame for this picture
  * @param pictureFrame the picture frame to use 
  */
 public void setPictureFrame(Z_Pixlab_PictureFrame pictureFrame)
 {
  ...
  */
 public Z_Pixlab_Pixel getPixel(int x, int y)
 {
   // create the pixel object for this picture and the given x and y location
   Z_Pixlab_Pixel pixel = new Z_Pixlab_Pixel(this,x,y);
   return pixel;
 }
  ...
  */
 public Z_Pixlab_Pixel[] getPixels()
 {
   int width = getWidth();
   int height = getHeight();
   Z_Pixlab_Pixel[] pixelArray = new Z_Pixlab_Pixel[width * height];
   
   // loop through height rows from top to bottom
   for (int row = 0; row < height; row++) 
     for (int col = 0; col < width; col++) 
       pixelArray[row * width + col] = new Z_Pixlab_Pixel(this,col,row);
  ...
  */
 public Z_Pixlab_Pixel[][] getPixels2D()
 {
   int width = getWidth();
   int height = getHeight();
   Z_Pixlab_Pixel[][] pixelArray = new Z_Pixlab_Pixel[height][width];
   
   // loop through height rows from top to bottom
   for (int row = 0; row < height; row++) 
     for (int col = 0; col < width; col++) 
       pixelArray[row][col] = new Z_Pixlab_Pixel(this,col,row);
 ...
 public void show()
 {
   ...
   // else create a new picture frame with this picture 
     ...
     pictureFrame = new Z_Pixlab_PictureFrame(this);
 }
 ...
 public void explore()
 {
   ...
   new SmC_Test_PixlabExplorer(new Z_Pixlab_SimplePicture(this));
 }
 ...
 public void loadOrFail(String fileName) throws IOException
 {
   ...
   if (!file.canRead()) 
   {
     ...
     file = new File(Z_Pixlab_FileChooser.getMediaPath(this.fileName));
     if (!file.canRead())
     {
 ...
 /**
   ...
   */
  public Z_Pixlab_Picture scale(double xFactor, double yFactor)
  {
    ...
    Z_Pixlab_Picture result = new Z_Pixlab_Picture((int) (getWidth() * xFactor),
   ...
   * @return the resulting picture
   */
  public Z_Pixlab_Picture getPictureWithWidth(int width)
  {
    // set up the scale transform
    double xFactor = (double) width / this.getWidth();
    Z_Pixlab_Picture result = scale(xFactor,xFactor);
    return result;
  }
   ...
   * @return the resulting picture
   */
  public Z_Pixlab_Picture getPictureWithHeight(int height)
  {
    // set up the scale transform
    double yFactor = (double) height / this.getHeight();
    Z_Pixlab_Picture result = scale(yFactor,yFactor);
    return result;
  }
 ...
 public void writeOrFail(String fileName) throws IOException
 {
   ...
   if (fileLoc == null)
   {
     fileName = Z_Pixlab_FileChooser.getMediaPath(fileName);
 ...
 public static String getMediaPath(String fileName) {
   return Z_Pixlab_FileChooser.getMediaPath(fileName);
 }
