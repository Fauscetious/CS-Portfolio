 ...
 */
public class SmC_Test_PixlabExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  private Z_Pixlab_DigitalPicture picture;
  
  /** The image icon used to display the picture */
  private ImageIcon scrollImageIcon;
  
  /** The image display */
  private Z_Pixlab_ImageDisplay imageDisplay;
   ...
   */
  public SmC_Test_PixlabExplorer(Z_Pixlab_DigitalPicture picture)
  {
    // set the fields
  ...
  private void createAndInitPictureFrame()
  {
    ...
    //pictureFrame.getContentPane().setLayout(new FlowLayout());
  ...
  private void setUpNextAndPreviousButtons()
  {
    ...
    Icon prevIcon = new ImageIcon(Z_Pixlab_DigitalPicture.class.getResource("leftArrow.gif"), 
                                  "previous index");
    Icon nextIcon = new ImageIcon(Z_Pixlab_DigitalPicture.class.getResource("rightArrow.gif"), 
                                  "next index");
  ...
  private JPanel createColorInfoPanel(Font labelFont)
  {
    ...
    Z_Pixlab_Pixel pixel = new Z_Pixlab_Pixel(picture,colIndex,rowIndex);
  ...
  {
    Z_Pixlab_Picture pix = new Z_Pixlab_Picture("testInput/HJocean.png");
    pix.explore();
  }
