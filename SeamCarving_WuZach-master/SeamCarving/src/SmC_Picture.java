/*************************************************************************
 *  Compilation:  javac SmC_Picture.java
 *  Execution:    java SmC_Picture imagename
 *
 ...
 */
public final class SmC_Picture implements ActionListener {
     ...
     */
    public SmC_Picture(int w, int h) {
        width = w;
        height = h;
     ...
     * Copy constructor.
     */
    public SmC_Picture(SmC_Picture pic) {
        width = pic.width();
        height = pic.height();
    ...
    public SmC_Picture(BufferedImage img)
    {
        width = img.getWidth();
     ...
     */
    public SmC_Picture(String filename) {
    ...
    /**
     * Return a JLabel containing this SmC_Picture, for embedding in a JPanel,
    ...
    /**
     * Is this SmC_Picture equal to obj?
     */
    public boolean equals(Object obj) {
        if (obj == this) return true;
        if (obj == null) return false;
        if (obj.getClass() != this.getClass()) return false;
        SmC_Picture that = (SmC_Picture) obj;
    ...
    public static void main(String[] args) {
        SmC_Picture pic = new SmC_Picture(args[0]);
