 ...
 */
public interface Z_Pixlab_DigitalPicture 
{
  ...
  public Z_Pixlab_Pixel getPixel(int x, int y); // get the pixel information as an object
  public Z_Pixlab_Pixel[] getPixels(); // get all pixels in row-major order
  public Z_Pixlab_Pixel[][] getPixels2D(); // get 2-D array of pixels in row-major order
